export const experiences = [
  ...
  {
    role:    { es: "Representante de Atención al Cliente & Ventas", en: "Customer Service & Sales Representative" },
    company: { es: "Call Center",                                    en: "Call Center" },
  ...
  {
    role:    { es: "Encargada de Atención al Público y Caja", en: "Customer Service & Cashier Manager" },
    company: { es: "Panadería Independencia (Negocio Propio)", en: "Panadería Independencia (Own Business)" },
    period:  { es: "2016 - 2021",                              en: "2016 - 2021" },
    description: {
